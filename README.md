...
![The YANuget package gallery listing five packages](.github/media/gallery.png)

Find a package, open it, copy the install command — the whole of what most
visitors ever do:

![Searching the gallery, opening a package and copying its install command](.github/media/gallery.gif)

The palette follows the browser's light or dark preference, with no setting to
find and nothing to configure:

![The same package page in dark and light themes](.github/media/theme.gif)

<table>
<tr>
<td width="50%"><a href=".github/media/package.png"><img src=".github/media/package.png" alt="A package detail page with its readme, dependencies and install commands"></a><br><sub><b>Package page</b> — readme, dependencies, versions, and install commands for Chocolatey, <code>dotnet</code> and <code>nuget.exe</code>.</sub></td>
<td width="50%"><a href=".github/media/first-run.png"><img src=".github/media/first-run.png" alt="An empty feed showing the three commands that fill it"></a><br><sub><b>First run</b> — an empty feed answers with the three commands that fill it, already carrying this server's own URL.</sub></td>
</tr>
<tr>
<td width="50%"><a href=".github/media/stats.png"><img src=".github/media/stats.png" alt="The statistics page"></a><br><sub><b>Statistics</b> — feed totals, most downloaded, recently published.</sub></td>
<td width="50%"><a href=".github/media/docs.png"><img src=".github/media/docs.png" alt="The documentation site served by the server itself"></a><br><sub><b>Offline docs</b> — the full documentation, embedded in the binary and served at <code>/docs</code>. No network required.</sub></td>
</tr>
</table>

Every image above is generated by
[`scripts/capture-media.sh`](scripts/capture-media.sh), which builds the server,
seeds a feed and drives a real browser against it — so what you see is what the
code renders, not a mock-up that drifted.
